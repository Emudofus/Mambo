...
trait PartyLeaveRequestMessage extends AbstractPartyMessage {
  override val messageId = 5593

  protected trait Message extends AbstractPartyMessage.Message with Serializable {
    override val messageId = PartyLeaveRequestMessage.messageId
...
object PartyLeaveRequestMessage extends PartyLeaveRequestMessage {
