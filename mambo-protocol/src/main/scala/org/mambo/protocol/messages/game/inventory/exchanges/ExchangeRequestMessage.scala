...
trait ExchangeRequestMessage extends MessageDeserializer {
  val messageId = 5505

  protected trait Message extends BaseMessage with Serializable {
    val messageId = ExchangeRequestMessage.messageId
...
object ExchangeRequestMessage extends ExchangeRequestMessage {
