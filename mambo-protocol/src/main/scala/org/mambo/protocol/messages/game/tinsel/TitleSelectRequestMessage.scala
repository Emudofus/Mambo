...
trait TitleSelectRequestMessage extends MessageDeserializer {
  val messageId = 6365

  protected trait Message extends BaseMessage with Serializable {
    val messageId = TitleSelectRequestMessage.messageId
...
object TitleSelectRequestMessage extends TitleSelectRequestMessage {
