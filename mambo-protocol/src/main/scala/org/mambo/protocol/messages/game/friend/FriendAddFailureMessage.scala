...
trait FriendAddFailureMessage extends MessageDeserializer {
  val messageId = 5600

  protected trait Message extends BaseMessage with Serializable {
    val messageId = FriendAddFailureMessage.messageId
...
object FriendAddFailureMessage extends FriendAddFailureMessage {
