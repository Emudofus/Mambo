...
trait ExchangeBidHouseGenericItemAddedMessage extends MessageDeserializer {
  val messageId = 5947

  protected trait Message extends BaseMessage with Serializable {
    val messageId = ExchangeBidHouseGenericItemAddedMessage.messageId
...
object ExchangeBidHouseGenericItemAddedMessage extends ExchangeBidHouseGenericItemAddedMessage {
