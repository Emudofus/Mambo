...
trait PrismFightJoinLeaveRequestMessage extends MessageDeserializer {
  val messageId = 5843

  protected trait Message extends BaseMessage with Serializable {
    val messageId = PrismFightJoinLeaveRequestMessage.messageId
...
object PrismFightJoinLeaveRequestMessage extends PrismFightJoinLeaveRequestMessage {
