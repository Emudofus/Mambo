...
trait GameActionFightInvisibleDetectedMessage extends AbstractGameActionMessage {
  override val messageId = 6320

  protected trait Message extends AbstractGameActionMessage.Message with Serializable {
    override val messageId = GameActionFightInvisibleDetectedMessage.messageId
...
object GameActionFightInvisibleDetectedMessage extends GameActionFightInvisibleDetectedMessage {
