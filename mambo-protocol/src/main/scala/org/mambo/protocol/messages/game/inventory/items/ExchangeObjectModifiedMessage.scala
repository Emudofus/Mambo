...
trait ExchangeObjectModifiedMessage extends ExchangeObjectMessage {
  override val messageId = 5519

  protected trait Message extends ExchangeObjectMessage.Message with Serializable {
    override val messageId = ExchangeObjectModifiedMessage.messageId
...
object ExchangeObjectModifiedMessage extends ExchangeObjectModifiedMessage {
