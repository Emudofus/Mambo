...
trait AchievementRewardSuccessMessage extends MessageDeserializer {
  val messageId = 6376

  protected trait Message extends BaseMessage with Serializable {
    val messageId = AchievementRewardSuccessMessage.messageId
...
object AchievementRewardSuccessMessage extends AchievementRewardSuccessMessage {
