...
trait GameActionNoopMessage extends MessageDeserializer {
  val messageId = 1002

  protected trait Message extends BaseMessage with Serializable {
    val messageId = GameActionNoopMessage.messageId
...
object GameActionNoopMessage extends GameActionNoopMessage {
