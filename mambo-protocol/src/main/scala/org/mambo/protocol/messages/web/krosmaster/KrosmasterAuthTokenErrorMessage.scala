...
trait KrosmasterAuthTokenErrorMessage extends MessageDeserializer {
  val messageId = 6345

  protected trait Message extends BaseMessage with Serializable {
    val messageId = KrosmasterAuthTokenErrorMessage.messageId
...
object KrosmasterAuthTokenErrorMessage extends KrosmasterAuthTokenErrorMessage {
