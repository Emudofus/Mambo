...
trait PaddockRemoveItemRequestMessage extends MessageDeserializer {
  val messageId = 5958

  protected trait Message extends BaseMessage with Serializable {
    val messageId = PaddockRemoveItemRequestMessage.messageId
...
object PaddockRemoveItemRequestMessage extends PaddockRemoveItemRequestMessage {
