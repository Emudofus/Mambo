...
trait DownloadPartMessage extends MessageDeserializer {
  val messageId = 1503

  protected trait Message extends BaseMessage with Serializable {
    val messageId = DownloadPartMessage.messageId
...
object DownloadPartMessage extends DownloadPartMessage {
