...
trait JobAllowMultiCraftRequestMessage extends MessageDeserializer {
  val messageId = 5748

  protected trait Message extends BaseMessage with Serializable {
    val messageId = JobAllowMultiCraftRequestMessage.messageId
...
object JobAllowMultiCraftRequestMessage extends JobAllowMultiCraftRequestMessage {
