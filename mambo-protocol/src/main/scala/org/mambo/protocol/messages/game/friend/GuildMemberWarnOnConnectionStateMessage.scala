...
trait GuildMemberWarnOnConnectionStateMessage extends MessageDeserializer {
  val messageId = 6160

  protected trait Message extends BaseMessage with Serializable {
    val messageId = GuildMemberWarnOnConnectionStateMessage.messageId
...
object GuildMemberWarnOnConnectionStateMessage extends GuildMemberWarnOnConnectionStateMessage {
