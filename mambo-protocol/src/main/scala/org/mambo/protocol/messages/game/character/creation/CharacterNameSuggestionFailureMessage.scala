...
trait CharacterNameSuggestionFailureMessage extends MessageDeserializer {
  val messageId = 164

  protected trait Message extends BaseMessage with Serializable {
    val messageId = CharacterNameSuggestionFailureMessage.messageId
...
object CharacterNameSuggestionFailureMessage extends CharacterNameSuggestionFailureMessage {
