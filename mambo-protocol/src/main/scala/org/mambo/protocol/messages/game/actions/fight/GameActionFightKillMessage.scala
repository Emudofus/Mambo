...
trait GameActionFightKillMessage extends AbstractGameActionMessage {
  override val messageId = 5571

  protected trait Message extends AbstractGameActionMessage.Message with Serializable {
    override val messageId = GameActionFightKillMessage.messageId
...
object GameActionFightKillMessage extends GameActionFightKillMessage {
