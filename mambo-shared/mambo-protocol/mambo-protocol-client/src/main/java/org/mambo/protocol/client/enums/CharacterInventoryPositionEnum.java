...
public enum CharacterInventoryPositionEnum {
    ...
    private int value;
    CharacterInventoryPositionEnum(int value) { this.value = value; }
    public int value() { return value; }
    
    public static CharacterInventoryPositionEnum valueOf(int value) {
    	for (CharacterInventoryPositionEnum a : values()) {
    		if (a.value == value)
    			return a;
    	}
    	return null;
