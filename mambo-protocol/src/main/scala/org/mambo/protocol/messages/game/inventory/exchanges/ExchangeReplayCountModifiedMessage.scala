...
trait ExchangeReplayCountModifiedMessage extends MessageDeserializer {
  val messageId = 6023

  protected trait Message extends BaseMessage with Serializable {
    val messageId = ExchangeReplayCountModifiedMessage.messageId
...
object ExchangeReplayCountModifiedMessage extends ExchangeReplayCountModifiedMessage {
