...
trait IdentificationFailedMessage extends MessageDeserializer {
  val messageId = 20

  protected trait Message extends BaseMessage with Serializable {
    val messageId = IdentificationFailedMessage.messageId
...
object IdentificationFailedMessage extends IdentificationFailedMessage {
