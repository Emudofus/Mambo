...
trait GuildFightJoinRequestMessage extends MessageDeserializer {
  val messageId = 5717

  protected trait Message extends BaseMessage with Serializable {
    val messageId = GuildFightJoinRequestMessage.messageId
...
object GuildFightJoinRequestMessage extends GuildFightJoinRequestMessage {
