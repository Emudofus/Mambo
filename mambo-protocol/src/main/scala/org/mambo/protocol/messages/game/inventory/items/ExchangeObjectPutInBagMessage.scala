...
trait ExchangeObjectPutInBagMessage extends ExchangeObjectMessage {
  override val messageId = 6009

  protected trait Message extends ExchangeObjectMessage.Message with Serializable {
    override val messageId = ExchangeObjectPutInBagMessage.messageId
...
object ExchangeObjectPutInBagMessage extends ExchangeObjectPutInBagMessage {
