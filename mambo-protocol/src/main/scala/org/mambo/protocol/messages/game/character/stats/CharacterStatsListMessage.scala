...
trait CharacterStatsListMessage extends MessageDeserializer {
  val messageId = 500

  protected trait Message extends BaseMessage with Serializable {
    val messageId = CharacterStatsListMessage.messageId
...
object CharacterStatsListMessage extends CharacterStatsListMessage {
