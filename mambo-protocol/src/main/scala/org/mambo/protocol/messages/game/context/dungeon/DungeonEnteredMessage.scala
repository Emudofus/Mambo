...
trait DungeonEnteredMessage extends MessageDeserializer {
  val messageId = 6152

  protected trait Message extends BaseMessage with Serializable {
    val messageId = DungeonEnteredMessage.messageId
...
object DungeonEnteredMessage extends DungeonEnteredMessage {
