...
trait ExchangeObjectMoveMessage extends MessageDeserializer {
  val messageId = 5518

  protected trait Message extends BaseMessage with Serializable {
    val messageId = ExchangeObjectMoveMessage.messageId
...
object ExchangeObjectMoveMessage extends ExchangeObjectMoveMessage {
