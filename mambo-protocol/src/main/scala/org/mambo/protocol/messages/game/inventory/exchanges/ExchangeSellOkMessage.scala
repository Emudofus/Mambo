...
trait ExchangeSellOkMessage extends MessageDeserializer {
  val messageId = 5792

  protected trait Message extends BaseMessage with Serializable {
    val messageId = ExchangeSellOkMessage.messageId
...
object ExchangeSellOkMessage extends ExchangeSellOkMessage {
