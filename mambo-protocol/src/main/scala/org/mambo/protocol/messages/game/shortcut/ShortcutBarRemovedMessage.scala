...
trait ShortcutBarRemovedMessage extends MessageDeserializer {
  val messageId = 6224

  protected trait Message extends BaseMessage with Serializable {
    val messageId = ShortcutBarRemovedMessage.messageId
...
object ShortcutBarRemovedMessage extends ShortcutBarRemovedMessage {
