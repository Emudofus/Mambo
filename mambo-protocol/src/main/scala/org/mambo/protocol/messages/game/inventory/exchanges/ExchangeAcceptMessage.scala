...
trait ExchangeAcceptMessage extends MessageDeserializer {
  val messageId = 5508

  protected trait Message extends BaseMessage with Serializable {
    val messageId = ExchangeAcceptMessage.messageId
...
object ExchangeAcceptMessage extends ExchangeAcceptMessage {
