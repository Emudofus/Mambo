...
trait EmotePlayRequestMessage extends MessageDeserializer {
  val messageId = 5685

  protected trait Message extends BaseMessage with Serializable {
    val messageId = EmotePlayRequestMessage.messageId
...
object EmotePlayRequestMessage extends EmotePlayRequestMessage {
