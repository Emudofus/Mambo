...
trait LockableChangeCodeMessage extends MessageDeserializer {
  val messageId = 5666

  protected trait Message extends BaseMessage with Serializable {
    val messageId = LockableChangeCodeMessage.messageId
...
object LockableChangeCodeMessage extends LockableChangeCodeMessage {
