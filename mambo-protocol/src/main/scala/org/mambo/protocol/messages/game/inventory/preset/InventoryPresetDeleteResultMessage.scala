...
trait InventoryPresetDeleteResultMessage extends MessageDeserializer {
  val messageId = 6173

  protected trait Message extends BaseMessage with Serializable {
    val messageId = InventoryPresetDeleteResultMessage.messageId
...
object InventoryPresetDeleteResultMessage extends InventoryPresetDeleteResultMessage {
