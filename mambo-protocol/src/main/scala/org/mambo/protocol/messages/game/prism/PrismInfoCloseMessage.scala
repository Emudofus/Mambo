...
trait PrismInfoCloseMessage extends MessageDeserializer {
  val messageId = 5853

  protected trait Message extends BaseMessage with Serializable {
    val messageId = PrismInfoCloseMessage.messageId
...
object PrismInfoCloseMessage extends PrismInfoCloseMessage {
