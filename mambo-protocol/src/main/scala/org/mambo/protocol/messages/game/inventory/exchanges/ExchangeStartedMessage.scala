...
trait ExchangeStartedMessage extends MessageDeserializer {
  val messageId = 5512

  protected trait Message extends BaseMessage with Serializable {
    val messageId = ExchangeStartedMessage.messageId
...
object ExchangeStartedMessage extends ExchangeStartedMessage {
