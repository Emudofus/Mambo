...
trait AcquaintanceSearchErrorMessage extends MessageDeserializer {
  val messageId = 6143

  protected trait Message extends BaseMessage with Serializable {
    val messageId = AcquaintanceSearchErrorMessage.messageId
...
object AcquaintanceSearchErrorMessage extends AcquaintanceSearchErrorMessage {
