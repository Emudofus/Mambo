...
trait PartyRefuseInvitationMessage extends AbstractPartyMessage {
  override val messageId = 5582

  protected trait Message extends AbstractPartyMessage.Message with Serializable {
    override val messageId = PartyRefuseInvitationMessage.messageId
...
object PartyRefuseInvitationMessage extends PartyRefuseInvitationMessage {
