...
trait GameFightReadyMessage extends MessageDeserializer {
  val messageId = 708

  protected trait Message extends BaseMessage with Serializable {
    val messageId = GameFightReadyMessage.messageId
...
object GameFightReadyMessage extends GameFightReadyMessage {
