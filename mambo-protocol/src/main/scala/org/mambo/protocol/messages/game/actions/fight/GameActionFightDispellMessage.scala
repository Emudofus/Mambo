...
trait GameActionFightDispellMessage extends AbstractGameActionMessage {
  override val messageId = 5533

  protected trait Message extends AbstractGameActionMessage.Message with Serializable {
    override val messageId = GameActionFightDispellMessage.messageId
...
object GameActionFightDispellMessage extends GameActionFightDispellMessage {
