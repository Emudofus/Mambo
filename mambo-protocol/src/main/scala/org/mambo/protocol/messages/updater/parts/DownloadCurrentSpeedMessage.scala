...
trait DownloadCurrentSpeedMessage extends MessageDeserializer {
  val messageId = 1511

  protected trait Message extends BaseMessage with Serializable {
    val messageId = DownloadCurrentSpeedMessage.messageId
...
object DownloadCurrentSpeedMessage extends DownloadCurrentSpeedMessage {
