...
trait PartyFollowMemberRequestMessage extends AbstractPartyMessage {
  override val messageId = 5577

  protected trait Message extends AbstractPartyMessage.Message with Serializable {
    override val messageId = PartyFollowMemberRequestMessage.messageId
...
object PartyFollowMemberRequestMessage extends PartyFollowMemberRequestMessage {
