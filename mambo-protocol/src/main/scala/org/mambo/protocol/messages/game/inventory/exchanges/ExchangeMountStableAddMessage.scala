...
trait ExchangeMountStableAddMessage extends MessageDeserializer {
  val messageId = 5971

  protected trait Message extends BaseMessage with Serializable {
    val messageId = ExchangeMountStableAddMessage.messageId
...
object ExchangeMountStableAddMessage extends ExchangeMountStableAddMessage {
