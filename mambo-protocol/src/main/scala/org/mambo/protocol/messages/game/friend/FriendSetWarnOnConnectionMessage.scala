...
trait FriendSetWarnOnConnectionMessage extends MessageDeserializer {
  val messageId = 5602

  protected trait Message extends BaseMessage with Serializable {
    val messageId = FriendSetWarnOnConnectionMessage.messageId
...
object FriendSetWarnOnConnectionMessage extends FriendSetWarnOnConnectionMessage {
