...
trait ShortcutBarRefreshMessage extends MessageDeserializer {
  val messageId = 6229

  protected trait Message extends BaseMessage with Serializable {
    val messageId = ShortcutBarRefreshMessage.messageId
...
object ShortcutBarRefreshMessage extends ShortcutBarRefreshMessage {
