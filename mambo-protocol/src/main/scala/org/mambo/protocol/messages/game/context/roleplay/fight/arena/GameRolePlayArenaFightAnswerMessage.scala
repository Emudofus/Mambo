...
trait GameRolePlayArenaFightAnswerMessage extends MessageDeserializer {
  val messageId = 6279

  protected trait Message extends BaseMessage with Serializable {
    val messageId = GameRolePlayArenaFightAnswerMessage.messageId
...
object GameRolePlayArenaFightAnswerMessage extends GameRolePlayArenaFightAnswerMessage {
