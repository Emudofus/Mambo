...
trait ExchangeObjectTransfertListFromInvMessage extends MessageDeserializer {
  val messageId = 6183

  protected trait Message extends BaseMessage with Serializable {
    val messageId = ExchangeObjectTransfertListFromInvMessage.messageId
...
object ExchangeObjectTransfertListFromInvMessage extends ExchangeObjectTransfertListFromInvMessage {
