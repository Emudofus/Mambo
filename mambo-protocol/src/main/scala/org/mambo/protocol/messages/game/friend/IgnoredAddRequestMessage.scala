...
trait IgnoredAddRequestMessage extends MessageDeserializer {
  val messageId = 5673

  protected trait Message extends BaseMessage with Serializable {
    val messageId = IgnoredAddRequestMessage.messageId
...
object IgnoredAddRequestMessage extends IgnoredAddRequestMessage {
