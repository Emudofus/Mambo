...
trait FriendsGetListMessage extends MessageDeserializer {
  val messageId = 4001

  protected trait Message extends BaseMessage with Serializable {
    val messageId = FriendsGetListMessage.messageId
...
object FriendsGetListMessage extends FriendsGetListMessage {
