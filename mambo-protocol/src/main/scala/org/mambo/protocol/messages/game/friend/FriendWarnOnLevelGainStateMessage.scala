...
trait FriendWarnOnLevelGainStateMessage extends MessageDeserializer {
  val messageId = 6078

  protected trait Message extends BaseMessage with Serializable {
    val messageId = FriendWarnOnLevelGainStateMessage.messageId
...
object FriendWarnOnLevelGainStateMessage extends FriendWarnOnLevelGainStateMessage {
