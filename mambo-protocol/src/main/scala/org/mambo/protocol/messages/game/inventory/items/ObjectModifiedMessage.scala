...
trait ObjectModifiedMessage extends MessageDeserializer {
  val messageId = 3029

  protected trait Message extends BaseMessage with Serializable {
    val messageId = ObjectModifiedMessage.messageId
...
object ObjectModifiedMessage extends ObjectModifiedMessage {
