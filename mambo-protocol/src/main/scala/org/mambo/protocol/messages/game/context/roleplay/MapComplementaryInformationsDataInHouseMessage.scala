...
trait MapComplementaryInformationsDataInHouseMessage extends MapComplementaryInformationsDataMessage {
  override val messageId = 6130

  protected trait Message extends MapComplementaryInformationsDataMessage.Message with Serializable {
    override val messageId = MapComplementaryInformationsDataInHouseMessage.messageId

    val currentHouse: HouseInformationsInside.TypeImpl
  ...
  protected def create(subAreaId: Short, mapId: Int, subareaAlignmentSide: Byte, houses: Seq[HouseInformations.TypeImpl], actors: Seq[GameRolePlayActorInformations.TypeImpl], interactiveElements: Seq[InteractiveElement.TypeImpl], statedElements: Seq[StatedElement.TypeImpl], obstacles: Seq[MapObstacle.TypeImpl], fights: Seq[FightCommonInformations.TypeImpl], currentHouse: HouseInformationsInside.TypeImpl): Target = throw new IllegalAccessException
  ...
  override def deserialize(buf: Buffer) = {
    ...
    val currentHouse = HouseInformationsInside.deserialize(buf)

    create(subAreaId, mapId, subareaAlignmentSide, houses, actors, interactiveElements, statedElements, obstacles, fights, currentHouse)
  }

}

object MapComplementaryInformationsDataInHouseMessage extends MapComplementaryInformationsDataInHouseMessage {
  case class MessageImpl(subAreaId: Short, mapId: Int, subareaAlignmentSide: Byte, houses: Seq[HouseInformations.TypeImpl], actors: Seq[GameRolePlayActorInformations.TypeImpl], interactiveElements: Seq[InteractiveElement.TypeImpl], statedElements: Seq[StatedElement.TypeImpl], obstacles: Seq[MapObstacle.TypeImpl], fights: Seq[FightCommonInformations.TypeImpl], currentHouse: HouseInformationsInside.TypeImpl) extends Message
  type Target = MessageImpl

  override def create(subAreaId: Short, mapId: Int, subareaAlignmentSide: Byte, houses: Seq[HouseInformations.TypeImpl], actors: Seq[GameRolePlayActorInformations.TypeImpl], interactiveElements: Seq[InteractiveElement.TypeImpl], statedElements: Seq[StatedElement.TypeImpl], obstacles: Seq[MapObstacle.TypeImpl], fights: Seq[FightCommonInformations.TypeImpl], currentHouse: HouseInformationsInside.TypeImpl) = MessageImpl(subAreaId, mapId, subareaAlignmentSide, houses, actors, interactiveElements, statedElements, obstacles, fights, currentHouse)

  def apply(subAreaId: Short, mapId: Int, subareaAlignmentSide: Byte, houses: Seq[HouseInformations.TypeImpl], actors: Seq[GameRolePlayActorInformations.TypeImpl], interactiveElements: Seq[InteractiveElement.TypeImpl], statedElements: Seq[StatedElement.TypeImpl], obstacles: Seq[MapObstacle.TypeImpl], fights: Seq[FightCommonInformations.TypeImpl], currentHouse: HouseInformationsInside.TypeImpl) = create(subAreaId, mapId, subareaAlignmentSide, houses, actors, interactiveElements, statedElements, obstacles, fights, currentHouse)
