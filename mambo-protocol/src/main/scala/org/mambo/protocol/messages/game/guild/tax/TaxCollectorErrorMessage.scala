...
trait TaxCollectorErrorMessage extends MessageDeserializer {
  val messageId = 5634

  protected trait Message extends BaseMessage with Serializable {
    val messageId = TaxCollectorErrorMessage.messageId
...
object TaxCollectorErrorMessage extends TaxCollectorErrorMessage {
