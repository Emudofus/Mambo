...
trait GameActionFightLifePointsGainMessage extends AbstractGameActionMessage {
  override val messageId = 6311

  protected trait Message extends AbstractGameActionMessage.Message with Serializable {
    override val messageId = GameActionFightLifePointsGainMessage.messageId
...
object GameActionFightLifePointsGainMessage extends GameActionFightLifePointsGainMessage {
