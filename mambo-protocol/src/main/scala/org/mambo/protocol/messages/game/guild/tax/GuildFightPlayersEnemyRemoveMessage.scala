...
trait GuildFightPlayersEnemyRemoveMessage extends MessageDeserializer {
  val messageId = 5929

  protected trait Message extends BaseMessage with Serializable {
    val messageId = GuildFightPlayersEnemyRemoveMessage.messageId
...
object GuildFightPlayersEnemyRemoveMessage extends GuildFightPlayersEnemyRemoveMessage {
