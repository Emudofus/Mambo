...
trait OrnamentSelectRequestMessage extends MessageDeserializer {
  val messageId = 6374

  protected trait Message extends BaseMessage with Serializable {
    val messageId = OrnamentSelectRequestMessage.messageId
...
object OrnamentSelectRequestMessage extends OrnamentSelectRequestMessage {
