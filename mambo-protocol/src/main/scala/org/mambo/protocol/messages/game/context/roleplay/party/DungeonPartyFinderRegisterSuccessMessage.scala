...
trait DungeonPartyFinderRegisterSuccessMessage extends MessageDeserializer {
  val messageId = 6241

  protected trait Message extends BaseMessage with Serializable {
    val messageId = DungeonPartyFinderRegisterSuccessMessage.messageId
...
object DungeonPartyFinderRegisterSuccessMessage extends DungeonPartyFinderRegisterSuccessMessage {
