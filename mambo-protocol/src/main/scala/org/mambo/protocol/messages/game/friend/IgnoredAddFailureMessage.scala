...
trait IgnoredAddFailureMessage extends MessageDeserializer {
  val messageId = 5679

  protected trait Message extends BaseMessage with Serializable {
    val messageId = IgnoredAddFailureMessage.messageId
...
object IgnoredAddFailureMessage extends IgnoredAddFailureMessage {
