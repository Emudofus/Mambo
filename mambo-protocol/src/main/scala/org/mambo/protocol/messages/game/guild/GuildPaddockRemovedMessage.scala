...
trait GuildPaddockRemovedMessage extends MessageDeserializer {
  val messageId = 5955

  protected trait Message extends BaseMessage with Serializable {
    val messageId = GuildPaddockRemovedMessage.messageId
...
object GuildPaddockRemovedMessage extends GuildPaddockRemovedMessage {
