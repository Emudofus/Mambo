...
trait PrismInfoJoinLeaveRequestMessage extends MessageDeserializer {
  val messageId = 5844

  protected trait Message extends BaseMessage with Serializable {
    val messageId = PrismInfoJoinLeaveRequestMessage.messageId
...
object PrismInfoJoinLeaveRequestMessage extends PrismInfoJoinLeaveRequestMessage {
