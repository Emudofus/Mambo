...
trait GameFightStartMessage extends MessageDeserializer {
  val messageId = 712

  protected trait Message extends BaseMessage with Serializable {
    val messageId = GameFightStartMessage.messageId
...
object GameFightStartMessage extends GameFightStartMessage {
