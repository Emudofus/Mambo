...
trait LoginQueueStatusMessage extends MessageDeserializer {
  val messageId = 10

  protected trait Message extends BaseMessage with Serializable {
    val messageId = LoginQueueStatusMessage.messageId
...
object LoginQueueStatusMessage extends LoginQueueStatusMessage {
