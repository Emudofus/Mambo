...
trait GameActionFightReflectDamagesMessage extends AbstractGameActionMessage {
  override val messageId = 5530

  protected trait Message extends AbstractGameActionMessage.Message with Serializable {
    override val messageId = GameActionFightReflectDamagesMessage.messageId
...
object GameActionFightReflectDamagesMessage extends GameActionFightReflectDamagesMessage {
