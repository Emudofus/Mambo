...
trait GuildLevelUpMessage extends MessageDeserializer {
  val messageId = 6062

  protected trait Message extends BaseMessage with Serializable {
    val messageId = GuildLevelUpMessage.messageId
...
object GuildLevelUpMessage extends GuildLevelUpMessage {
