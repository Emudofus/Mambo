...
trait MapInformationsRequestMessage extends MessageDeserializer {
  val messageId = 225

  protected trait Message extends BaseMessage with Serializable {
    val messageId = MapInformationsRequestMessage.messageId
...
object MapInformationsRequestMessage extends MapInformationsRequestMessage {
