...
trait IgnoredGetListMessage extends MessageDeserializer {
  val messageId = 5676

  protected trait Message extends BaseMessage with Serializable {
    val messageId = IgnoredGetListMessage.messageId
...
object IgnoredGetListMessage extends IgnoredGetListMessage {
