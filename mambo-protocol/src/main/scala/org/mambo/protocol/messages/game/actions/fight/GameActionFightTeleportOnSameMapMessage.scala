...
trait GameActionFightTeleportOnSameMapMessage extends AbstractGameActionMessage {
  override val messageId = 5528

  protected trait Message extends AbstractGameActionMessage.Message with Serializable {
    override val messageId = GameActionFightTeleportOnSameMapMessage.messageId
...
object GameActionFightTeleportOnSameMapMessage extends GameActionFightTeleportOnSameMapMessage {
